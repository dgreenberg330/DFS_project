...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Hero */}
      <div className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-100 pt-16 pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-200">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Compete & Win</h4>
              <p className="text-sm text-gray-600">
        ...
        {/* Rules */}
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-200">
          <h3 className="text-xl font-bold text-gray-900 mb-6">Contest Rules</h3>
